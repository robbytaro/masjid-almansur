...
<?php 	
	$id_km = @$_GET['id_km'];
	$sql = mysqli_query($db, "select * from kajian_mingguan where id_km = '$id_km'") or die ($db->error);
...
<body>
	<div class="container">
		<div class="row">
	    	...
	    	<table><thead><th class="center">Edit Data Kajian Mingguan</thead></table></th>
	      <div class="row">
	        <div class="input-field col s12">
	          <input type="text" name="id_km" value="<?php echo $data['id_km']; ?>" readonly="readonly" required="required">
		...
		if($edit_km){
			if($judul_kajian == "" || $pengisi_kajian == "" || $tanggal_kajian == "" ||  $keterangan == ""){
				...
				if($nama_gambar == ""){
				mysqli_query($db, "update kajian_mingguan set judul_kajian = '$judul_kajian',
